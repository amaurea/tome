...
extern u16b monster_ego_idx[MEGO_MAX_STACK];
...
extern bool allow_clones;
extern bool ego_uniques;
...
extern int interval_project_hack;
...
extern void monster_race_track(int r_idx, u16b * ego);
extern void object_track(object_type *o_ptr);
extern void disturb(int stop_search, int flush_output);
extern int is_quest(int level);
extern int random_quest_number(void);
extern int new_effect(int type, int dam, int time, int cy, int cx, int rad, int who, int interval, s32b flags);
extern int compare_effect(int,int);
...
extern int display_allies(int pets);
extern bool dismiss_pet(int m_idx);
...
extern int add_effect_tile(cave_type * c_ptr, int effect);
extern void clear_effect_tile(cave_type * c_ptr, int index);
extern void clear_all_effects_tile(cave_type * c_ptr);
...
/* monster1.c */
extern void screen_roff(int r_idx, u16b * ego, int remember);
extern void display_roff(int r_idx, u16b * ego);
extern void monster_description_out(int r_idx, u16b * ego);
...
extern bool m_live(s16b);
extern errr get_mon_num_prep(void);
extern s16b get_mon_num(int level);
extern void monster_desc(char *desc, monster_type *m_ptr, int mode);
extern void monster_race_desc(char *desc, int r_idx, u16b * ego);
...
extern s16b place_monster_one(int y, int x, int r_idx, u16b * ego, bool slp, int status);
...
extern void set_hp(int value, cptr kb_str);
extern void set_sp(int value);
extern void modify_hp(int value, cptr kb_str);
extern void modify_sp(int value);
extern void melkor_help(int percent);
extern int symbiote_shield(int damage);
...
extern void do_player_unlight(int dam, int who, int fuzzy);
extern int do_monster_unlight(int * dam, int m_idx, int who, int seen, char ** note);
...
extern void get_effective_flags(int * f1, int * f2, int * f3, int * f4, int * f5, int * esp);
...
extern bool get_aim_xy(int * eflg, int * x, int * y);
...
extern s32b skill_base(int i);

extern byte get_gf_color(int);
extern char *get_gf_name(int);

...
#define TV_RUNE_ELEM    106
#define TV_RUNE_POWER   107
#define TV_RUNE_SHAPE   108
...
/* sval codes for runes */
#define SV_RUNE_ARROW  0
#define SV_RUNE_SELF   1
#define SV_RUNE_SPHERE 2
#define SV_RUNE_BEAM   3
#define SV_RUNE_SHOWER 4
#define SV_RUNE_VIEW   5
...
#define SV_AMMO_DEATH                    3  /* death pebble */
...
#define CAVE_NEW_SAVE   0x8000    /* Reserved bit for detecting new saves */
...
#define GF_UNLIGHT      111
#define GF_UNHOLY_DRAIN 112
#define GF_WEB          113
#define MAX_GF          114
...
#define RUNE2_HIT_SELF          0x00000001L
#define RUNE2_HIT_GROUND        0x00000002L
#define RUNE2_CAN_AIM           0x00000004L
#define RUNE2_BEAM              0x00000008L
#define RUNE2_BALL              0x00000010L
#define RUNE2_SHOWER            0x00000020L
#define RUNE2_VIEW              0x00000040L
#define RUNE2_STAY              0x00000080L
#define RUNE2_WAVE              0x00000100L
#define RUNE2_STORM             0x00000200L
...
#define TR5_RETURNING           0X00020000L     /* Missile returns to quiver */
#define TR5_INSULATE            0X00040000L     /* Staff or wand cannot be drained */
#define TR5_PVAL                0x00000220L
...
#define DF2_INVERT_LIFE         0x00020000L     /* Only killed monsters may appear */
#define DF2_INVERT_DEATH        0x00040000L     /* Killed monsters reduce death count */
#define DF2_NO_UNIQUES          0x00080000L     /* No uniques allowed */
#define DF2_NO_NONUNIQUES       0x00100000L     /* No non-unique monsters allowed */
...
#define RF7_UNLIGHT             0x00200000  /* Hack for Ungoliant */
...
#define RF9_SPIN_WEB            0x00008000      /* Can spin webs */
...
#define MEGO_MAX_STACK          16      /* Max number of egos a single monster can have */
...
#define HOOK_SAVE_START         78
#define HOOK_GF_NAME            79
#define HOOK_HP_CHANGED         80
#define HOOK_SP_CHANGED         81
#define HOOK_SN_CHANGED         82
#define HOOK_PLAYER_ATTACKED    83
#define HOOK_PLAYER_HIT         84
#define MAX_HOOKS               85
...
#else
#define GOD(g)                  if (p_ptr->pgod == (g) || (p_ptr->pgod == GOD_POLYTHEISM && (g) != GOD_NONE))
#define PRAY_GOD(g)             if ((p_ptr->pgod == (g) || (p_ptr->pgod == GOD_POLYTHEISM && (g) != GOD_NONE)) && p_ptr->praying)
#define NOT_PRAY_GOD(g)         if ((p_ptr->pgod == (g) || (p_ptr->pgod == GOD_POLYTHEISM && (g) != GOD_NONE)) && !p_ptr->praying)
#endif
...
#define AB_DEVICE_MASTERY       11
#define AB_ARCANE_LANCE         12

/* Misc */
#define CHANCE_UNIT        0x10000
#define SHEET_NOVAL        0x10000

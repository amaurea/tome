...
DEMON_BLADE = add_spell
{
	...
	["spell"] =     function()
			...
			return set_project(5 + randint(15) + get_level(DEMON_BLADE, 80),
				type, 4 + get_level(DEMON_BLADE, 40), rad, bor(PROJECT_STOP, PROJECT_KILL))
	end,
	["info"] =      function()
			return "dur "..(5+get_level(DEMON_BLADE, 80)).."+d15 dam "..(4 + get_level(DEMON_BLADE, 40)).."/blow"
	end,
	["desc"] =      {
...
DEMON_FIELD = add_spell
{
	...
	["spell"] =     function()
			...
			ret, dir = get_aim_dir()
			if ret == FALSE then return end
			return fire_cloud(GF_NEXUS, dir, 20 + get_level(DEMON_FIELD, 70), 7, 30 + get_level(DEMON_FIELD, 100),get_level(DEMON_FIELD,20))
	end,
	["info"] =      function()
			return "dam "..(20 + get_level(DEMON_FIELD, 70)).." dur "..(30 + get_level(DEMON_FIELD, 100)).." speed "..get_level(DEMON_FIELD,20)
	end,
	["desc"] =      {

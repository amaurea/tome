...
-- Should probably be moved to core
tome_dofile("tim_effect.lua")
tome_dofile("counter_attack.lua")
...
--Allows several brands on a weapon
tome_dofile("brands.lua")

--Remind player of currently active effects
tome_dofile("status.lua")

...
REGENERATION = add_spell
{
	...
	["inertia"] = 	{ 4, 5 },
	["spell"] = 	function()
			set_tim_regen(randint(10) + 5 + get_level(REGENERATION, 50), 1500 + get_level(REGENERATION, 1500))
	end,
	["info"] = 	function()
			local r = (500 + get_level(REGENERATION, 1500))*player.mhp/65536
			return "dur "..(5 + get_level(REGENERATION, 50)).."+d10 "..r.."hp/turn"
	end,
	["desc"] =	{

...
TIDALWAVE = add_spell
{
	...
	["inertia"] = 	{ 5, 30 },
	["spell"] = 	function()
			fire_wave(GF_WAVE, 0, 40 + get_level(TIDALWAVE, 200), 0, 6 + get_level(TIDALWAVE, 10), EFF_WAVE, get_level(TIDALWAVE,15))
			return TRUE
	end,
	["info"] = 	function()
			return "dam "..(40 + get_level(TIDALWAVE,  200)).." rad "..(6 + get_level(TIDALWAVE,  10)).." speed "..get_level(TIDALWAVE,15)
	end,
	["desc"] =	{
...
ICESTORM = add_spell
{
	...
	["spell"] = 	function()
			...
			fire_wave(type, 0, 80 + get_level(ICESTORM, 200), 1 + get_level(ICESTORM, 3, 0), 20 + get_level(ICESTORM, 70), EFF_STORM,get_level(ICESTORM,25))
			return TRUE
	end,
	["info"] = 	function()
			return "dam "..(80 + get_level(ICESTORM, 200)).." rad "..(1 + get_level(ICESTORM, 3, 0)).." dur "..(20 + get_level(ICESTORM, 70)).." speed "..get_level(ICESTORM,25)
	end,
	["desc"] =	{

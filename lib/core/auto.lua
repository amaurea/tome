...
function auto_aux:add_child(sel)
	...
	-- Only <and> and <or> can contain. Oh, and <inventory> and <equipment>, too
	if auto_aux.rule.label ~= "rule" and auto_aux.rule.label ~= "and" and auto_aux.rule.label ~= "or"  and auto_aux.rule.label ~= "not" and auto_aux.rule.label ~= "inventory" and auto_aux.rule.label ~= "equipment" then return end
